...
public class CompanyFullDto {
  ...
  private List<PersonDto> employees = new ArrayList<PersonDto>();
  ...
  public void setEmployees(List<PersonDto> employees) {
  ...
  public String toString()  {
    ...
    sb.append("class CompanyFullDto {\n");
